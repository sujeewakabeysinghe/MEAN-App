...
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
 ...
 //imported router modules and add it into imports
 //imported form modules and add it into imports
 //imported this for send data to backend
 //imported this for send data to backend
 ...
 //imported auth service and add it into providers
 //imported auth guard and add it into providers
var AppRoutes = [
    ...
    { path: 'profile', component: _profile_profile_component__WEBPACK_IMPORTED_MODULE_12__["ProfileComponent"], canActivate: [_services_auth_guard__WEBPACK_IMPORTED_MODULE_14__["AuthGuard"]] }
];
...
var __metadata = (undefined && undefined.__metadata) || function (k, v) {
 ...
 //imported auth service

 //imported router for navigate to login form
var LoginComponent = /** @class */ (function () {
    function LoginComponent(authservice, //added auth service
    flashmessage, router) {
    ...
    LoginComponent.prototype.loginData = function () {
        ...
        //console.log(user);
        this.authservice.loguser(user).subscribe(function (res) {
            //console.log(res);
            if (res.state) {
                ...
                _this.authservice.storeuser(res.token);
...
var NavbarComponent = /** @class */ (function () {
    function NavbarComponent(authservice, //added auth service
    flashmessage) {
        this.authservice = authservice;
        this.flashmessage = flashmessage;
    }
...
var RegisterComponent = /** @class */ (function () {
    function RegisterComponent(authservice, //added auth service
    flashmessage, router) {
        this.authservice = authservice;
        this.flashmessage = flashmessage;
        this.router = router;
    ...
    RegisterComponent.prototype.registerData = function () {
        ...
        //console.log(user);
        this.authservice.adduser(user).subscribe(function (res) {
            //console.log(res);
            if (res.state) {
                _this.flashmessage.showFlashMessage({
                    messages: [res.msg],
...
var __metadata = (undefined && undefined.__metadata) || function (k, v) {
 ...
 //may need to install this also rxjs-compat
 //imported to know whether token expiration
var AuthService = /** @class */ (function () {
    ...
    AuthService.prototype.storeuser = function (token) {
    ...
    AuthService.prototype.loggedin = function () {
        return Object(angular2_jwt__WEBPACK_IMPORTED_MODULE_3__["tokenNotExpired"])('Token'); //ser your token name on Local storage
    };
...
module.exports = __webpack_require__(/*! D:\Education\Technologies\MEAN stack\english\MEAN App\angular\src\main.ts */"./src/main.ts");
